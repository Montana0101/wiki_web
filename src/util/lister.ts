...
//   // created
//   function created(callback: () => void, state?: State) {
//     // 参数合并
//     if (state) {
...
//     const query = { ...state.query, ...state.extraQuery }
//     // psa带上租户信息
//     if (core.isPsa()) {
...
//       return
//     }
//     const status = await element.confirm(config.confirmTip)
//     if (!status) {
//       return
//     }
